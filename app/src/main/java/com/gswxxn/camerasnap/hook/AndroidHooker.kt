...
object AndroidHooker: YukiBaseHooker() {
    ...
    override fun onHook() {
        ...
        "com.android.server.am.ActivityManagerService".toClass().method {
            ...
            before {
                ...
                if (appContext!!.packageManager.getPackageUid("com.android.camera", PackageManager.MATCH_ALL) == uid &&
                    ...
                    YLog.info(msg = "allow android.permission.FOREGROUND_SERVICE privilege")
                    resultNull()
                }
            }
        }
        ...
        "com.android.server.policy.BaseMiuiPhoneWindowManager".toClass().method {
            ...
            before {
                ...
                val hasStreetSnapMethod = runCatching {
                    instanceClass!!.declaredMethods.first { it.name == "streetSnap" }
                }.isSuccess
